        ...
        Axios
            ...
            .then(response => {
                ...
                if (response.data.success) {
                    ...
                    response.data.likes.map(like => { if (like.userId === props.userId) setLikeAction('liked') })
                } else {
        ...
        Axios
            ...
            .then(response => {
                ...
                if (response.data.success) {
                    ...
                    response.data.dislikes.map(dislike => { if (dislike.userId === props.userId) setDislikeAction('disliked') })
                } else {
